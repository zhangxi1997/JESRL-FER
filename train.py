...
def main():
    ...
    parser.add_argument('--lambda_vgg_loss', type=float, default=15.0, help="weith for vgg_loss")
    parser.add_argument('--l1_loss', action='store_true', default = True, help='use l1_loss or not')
    parser.add_argument('--lambda_l1_loss', type=float, default=5.0, help="weith for l1_loss")
    parser.add_argument('--tv_loss', action='store_true', default = True, help='use tv_loss or not')
    ...
    parser.add_argument('--lambda_l2_loss', type=float, default=10.0, help="weith for l2_loss")
    parser.add_argument('--lambda_D', type=float, default=0.25, help="weith for Discriminator loss")
    parser.add_argument('--G_max', type=float, default=22.0, help="G max loss")

    parser.add_argument('--label_copy', type=int, default=20, help="times to copy label")
    parser.add_argument('--decoder_label', action='store_true', default = True, help="add decoder label or not")
    parser.add_argument('--exp_label', action='store_true', default = False, help="add exp label or not")

    parser.add_argument('--std', type=float, default=0.2, help="smooth loss for GAN")
    parser.add_argument('--alpha5',action='store_true',default = True,help='add the half switch or not')

    # classify parameters
    parser.add_argument('--VGG',default = True,type = bool, help='whether train the classify net VGG')
    ...
    parser.add_argument('--multi_add_gan',action='store_true', help='whether use multi-add gan picture')
    parser.add_argument('--ablation',action='store_true', help='whether in the ablation mode')
